              ...
              <form action={updateAppSettings} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
                    {Object.values(THEMES).map((t) => (
                      <div key={t.key} className={'rounded-md border p-2 ' + (settings.color_theme === t.key ? 'border-primary ring-2 ring-primary/20' : '')}>
                        <div className="h-6 rounded mb-1" style={{ background: 'hsl(' + t.vars['--primary'] + ')' }} />
