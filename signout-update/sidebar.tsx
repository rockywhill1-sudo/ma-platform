...
export function Sidebar({ currentCompany, companies: _, user, demo = false }: Props) {
      ...
      <div className="p-3 border-b">
        <Link href="/" className="block px-2 py-1 mb-2 hover:opacity-80 transition-opacity">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold tracking-tight text-sm truncate">M&amp;A Platform</span>
          </div>
        </Link>
